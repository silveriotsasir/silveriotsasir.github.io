var questions = new Array(["¿Sabrías protegerte adecuadamente ante la situación del covid19?", 1, 2],
                          ...
                          ["¿Todas las mascarillas son efectivas?", 1,0],
                          ["Las mascarillas fabricadas en casa no tienen efectividad comprobada",1,2],
                          ["¿Sabrias lavarte las manos correctamente?",3,2],
                          ["Lo ideal es hacer un lavado con agua y jabon intenso y energico durante unos cuantos minutos(recuerda mantener el grifo cerrado mientras frotas) y por ammbas caras, o usar un gel hidroalcolico con una proporcion de alcohol superior al 60%. No hace falta hacer ambas cosas : lavarse las manos con agua y jabon y usar gel hidroalcolico, aunque si se quiere usar las dos cosas no estaria mal del todo",0,2], );
var index = 0; 
