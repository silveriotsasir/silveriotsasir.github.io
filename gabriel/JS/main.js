var questions = new Array(["¿Sabrías protegerte adecuadamente ante la situación del covid19?", 1, 2],
                          ...
                          ["Lo ideal es hacer un lavado con agua y jabón intenso y energético durante unos cuantos minutos (recuerda mantener el grifo cerrado mintras frotas) y por ambas caras, o usar un gel hidroalcohólico con una proporción superior al 60%.<<No jace falta hacer ambas cosas: lavarse las  manos con agua y jabón y usar el gel hidroalcohólico, aunque si quiere usar las dos cosas no estaría mal del todo>>.", 0 , 0]);
var index = 0;
