var questions = new Array(["¿Sabrías protegerte adecuadamente ante la situación del covid19?", 1, 2],
                          ...
                          ["Lo ideal es hacer un lavado con agua y jabón intenso y enérgico durante unos pocos minutos (recuerda mantener el grifo cerrado mientras frotas) y por ambas caras, o usar un gel hidroalcohólico con una cantidad de alcohol superior al 60%.  «No haga falta hacer ambas cosas: lavar las manos con agua y jabón y usar gel hidroalcohólico, aunque si se quiere usar las dos cosas sin usar mal del todo»,", 0 , 0]);
var index = 0;
